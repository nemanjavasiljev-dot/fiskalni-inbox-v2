...
export async function POST(request:Request){
  ...
  await ctx.admin.from("master_notification_log").insert({channel:"email",target_organization_ids:ids,subject:String(subject),body:String(message),recipient_count:emails.size,sent_count:sent,created_by:ctx.user.id});
