...
export default function ClientWorkspace({organization,selectedMonth,receipts,documents,receiptStatuses,documentStatuses}:any){
  ...
  function downloadAll(type:"receipts"|"documents"){
    window.open(`/api/accountant/clients/${organization.id}/download-all?type=${type}&month=${encodeURIComponent(selectedMonth)}`,"_blank","noopener,noreferrer");
  }
