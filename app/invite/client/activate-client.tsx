...
export default function ActivateClient({token}:{token:string}){
  ...
  async function activate(e:React.FormEvent){
    ...
    }catch{setError('Veza sa serverom je prekinuta. Pokušajte ponovo.');}finally{setBusy(false);}
  }
  ...
  if(done)return <div className="invite-activate"><CheckCircle2 size={42}/><h1>Nalog je kreiran</h1><p>Vaše korisničko ime je <b className="mono">{done.username}</b>.</p><p className="muted">Otvorite email i potvrdite adresu pre prijave.</p></div>;
