...
import { Bell, BriefcaseBusiness, CreditCard, Download, FileText, LayoutDashboard, Menu, Settings, Users, X } from "lucide-react";
...
export default function AccountantDesktopMenu({
  ...
  return <>
    ...
    <aside className={`accountant-desktop-menu accountant-super-menu ${mobileOpen?"mobile-open":""}`}>
      ...
      <div className="accountant-menu-user"><span>{isAdmin?"ADMIN KNJIGOVOĐA":"KNJIGOVOĐA"}</span><b>{username||"FiscalBox KNJIGO"}</b></div>
